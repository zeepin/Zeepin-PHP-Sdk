...
class Address
{
  ...
  public static function generateZPTid(PublicKey $pubkey) : string
  {
    $addr = self::fromPubKey($pubkey);
    $id = 'did:zpt:' . $addr->toBase58();
    return $id;
  }

  public static function fromZptId(string $id) : self
  {
