...
class JsonRpc
{
  ...
  public function getUnclaimedGala(Address $address) : JsonRpcResult
  {
    return $this->getAllowance('gala', new Address(ZptAssetTxBuilder::ZPT_CONTRACT), $address);
  }
}
